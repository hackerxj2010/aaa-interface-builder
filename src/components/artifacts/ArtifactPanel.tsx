    ...
    <aside className="flex h-full w-[460px] flex-col border-l border-border-subtle bg-surface">
      <div className="flex items-center justify-between border-b border-border-subtle px-4 py-3">
        ...
        <div className="flex items-center gap-1">
          ...
          <Button size="sm" className="h-8">Publier</Button>
          {onClose && (
      ...
      <Tabs defaultValue="preview" className="flex flex-1 flex-col">
        ...
        <TabsContent value="preview" className="flex-1 overflow-auto p-4">
          <div className="prose prose-invert max-w-none">
            <h2 className="font-serif">Théorème de Thalès</h2>
            <p>
              Si dans un triangle ABC, un point D est sur [AB], un point E est sur [AC],
              et si (DE) est parallèle à (BC), alors :
            </p>
